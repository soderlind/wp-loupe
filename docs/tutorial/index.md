...
With **WP Loupe**, you can *fine-tune what content is indexed, configure filters/sorting, and securely expose search via REST API, blocks, and even machine (AI) interfaces (MCP)*.
...
"]
    A6["Block & Form Integration (WP_Loupe_Blocks)
"]
...
"]
    ...
    A6 -- "Discovers filterable fields..." --> A4
    A6 -- "Reflects field settings from" --> A5
...
3. [Block & Form Integration (WP_Loupe_Blocks)
](03_block___form_integration__wp_loupe_blocks__.md)
4. [REST API Handler (WP_Loupe_REST)
](04_rest_api_handler__wp_loupe_rest__.md)
5. [MCP Server (WP_Loupe_MCP_Server & related)
](05_mcp_server__wp_loupe_mcp_server___related__.md)
6. [WP Loupe Search Engine (WP_Loupe_Search_Engine)
](06_wp_loupe_search_engine__wp_loupe_search_engine__.md)
7. [Indexing & Document Preparation (WP_Loupe_Indexer)
](07_indexing___document_preparation__wp_loupe_indexer__.md)
8. [Schema Manager (WP_Loupe_Schema_Manager)
](08_schema_manager__wp_loupe_schema_manager__.md)
9. [Database Management (WP_Loupe_DB)
](09_database_management__wp_loupe_db__.md)
10. [Factory & Utilities (WP_Loupe_Factory, WP_Loupe_Utils)
